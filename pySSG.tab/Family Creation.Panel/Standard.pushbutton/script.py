"""
This script adds the SSG Standard parameters to the family.
"""
import clr
...
for replace_param in replace_list:
    shared_replace_list.append(share_match(sharedParametersFile, replace_param.Definition.Name))
    # print replace_param
...
with revit.Transaction("Add standard parameters"):
    ...
    for key, value in std_params.items():
        ...
        try:
            print('Adding "{}" Shared Parameter to Group ({})'.format(shared_param.Name, value))
