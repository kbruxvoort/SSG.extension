"""
This script populates a secondary spec guide PDF with parameters from selected families. This is best used with nested shared families. Your active view must be a 3D View.
"""
import math
import itertools
