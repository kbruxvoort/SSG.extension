...
if rooms:
    ...
    with revit.TransactionGroup("Create room schedules"):
        if not equip_schedule:
            # Create schedule
            
            with revit.Transaction("Create Template Schedule"):
                field_list = [
                ...
                my_schedule = ScheduleWrapper.create(revit.doc, name="Template Equipment Schedule", show_grand_total=True, show_grand_total_title=True, grand_total_title="Grand Total:")
                for f in field_list:
        ...
        with revit.Transaction("Create filtered schedules"):    
            for room in rooms:
