        ...
        with open(source_file, "rb") as csv_file:
            ...
            for mat in csv_reader:
                ...
                if DB.Material.IsNameUnique(revit.doc, mat_name):
                    ...
                    message = (
                        '"%s" already exists. Attempting to edit parameters' % mat_name
                    )
                    ...
                    fRule = DB.FilterStringRule(
                        namePar, DB.FilterStringEquals(), mat_name, True
                    )
                ...
                if mat_comments:
                    comments = new_mat.get_Parameter(
                ...
                if mat_mfg:
                    manufacturer = new_mat.get_Parameter(
                ...
                try:
                    ...
                    print(
                        "Use Render Appearance Failed. Make sure you are using 0 or 1 values"
                    )
                if use_render:
                ...
                # ----- APPEARANCE TAB -----
                with DB.Visual.AppearanceAssetEditScope(
                    assetElem.Document
                ) as editScope:
